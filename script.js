...
var APPS = {
    ...
    'settings': {title: 'Settings', internal: true, icon: 'https://cdn.iconscout.com/icon/free/png-256/free-apple-settings-icon-svg-download-png-493162.png', pinned: true, openMode: "iframe"   // or "newtab" or "redirect"
},
};
